...
_AddSpecies = True
_ExternalFields = True
_AppliedFields = False
...
density = n_solar.si.value/10000
...
if _ParticleDiagnostic & _AddSpecies:
...
warpx.Bx_external_grid_function(x,y,z) = {Bx_expression}
warpx.By_external_grid_function(x,y,z) = {By_expression}
warpx.Bz_external_grid_function(x,y,z) = {Bz_expression}

my_constants.p0_x={s_d.si.value}
my_constants.p0_y={0}
my_constants.p0_z={0}
my_constants.m_d_x={m_d[0].si.value}
my_constants.m_d_y={m_d[1].si.value}
my_constants.m_d_z={m_d[2].si.value}
my_constants.b_IMF_x={b_IMF[0].si.value}
my_constants.b_IMF_y={b_IMF[1].si.value}
my_constants.b_IMF_z={b_IMF[2].si.value}
"""


def append_external_fields():
    with open("inputs", mode="a", encoding="utf-8") as f:
        f.write(external_fields)

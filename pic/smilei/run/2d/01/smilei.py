...
_test_mode = True
smilei_version='4.6-734-gd021d9e08-master'
smilei_mpi_size = 1
...
scalarEvery = number_of_timesteps / 1000
fieldEvery = diagEvery
probeEvery = number_of_timesteps / 1000
...
DiagProbe(
    ...
    corners=[[Main.grid_length[0], Main.grid_length[1] * 1 / 2]],

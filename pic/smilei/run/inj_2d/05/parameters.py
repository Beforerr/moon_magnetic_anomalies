...
timestep = 0.999 / np.sqrt(sum(1 / np.square(cell_length)))
...
if __name__ == "__main__":
    ...
    ic(v_sw, v_sw / V_r)
    ic(B_IMF,E_IMF_z.to(V/m), B_IMF_norm.si,E_IMF_z_norm.si)
    for species in solar_species:
        ic(
            species.name,
            species.mass_norm,
